...
/* Randomized quick sort to routine to sort a population based on a particular objective chosen */
...
/* Randomized quick sort to routine to sort a population based on a particular real variable chosen */
void quicksort_front_realvar(population *pop, int varcount, int var_array[], int var_array_size)
{
  q_sort_front_realvar (pop, varcount, var_array, 0, var_array_size-1);
  return;
}

/* Actual implementation of the randomized quick sort used to sort a population based on a particular real variable chosen */
void q_sort_front_realvar(population *pop, int objcount, int obj_array[], int left, int right)
{
    int index;
    int temp;
    int i, j;
...
/* Randomized quick sort to routine to sort a population based on a particular binary variable chosen */
void quicksort_front_binvar(population *pop, int varcount, int var_array[], int var_array_size)
{
  q_sort_front_binvar (pop, varcount, var_array, 0, var_array_size-1);
  return;
}

/*Actual implementation of the randomized quick sort used to sort a population based on a particular binary variable chosen*/
void q_sort_front_binvar(population *pop, int objcount, int obj_array[], int left, int right)
{
    int index;
    int temp;
    int i, j;
...
/* Randomized quick sort to routine to sort a population based on crowding distance */
